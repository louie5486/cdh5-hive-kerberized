...
FROM hswarm/cdh5-hive
MAINTAINER Teradata Docker Team <docker@teradata.com>

# Replace repo
RUN rm /etc/yum.repos.d/*

RUN curl -o /etc/yum.repos.d/CentOS-Base.repo http://mirrors.vpnforgame.net/centos/6/CentOS-Base.repo

RUN curl -o /etc/yum.repos.d/epel.repo http://mirrors.vpnforgame.net/epel/6/epel.repo
